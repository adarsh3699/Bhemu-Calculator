...
import { Sparkles, Briefcase, GraduationCap, Brain, Check, ArrowRight } from "lucide-react";
...
export default function OnboardingPage() {
	...
	const handleContinue = () => {
		// Save goal preference and redirect to dashboard
	...
	return (
		<div className="min-h-screen bg-background font-sans text-white">
						...
						<div className="max-w-[1000px] w-full flex flex-col items-center text-center">
							...
							<div className="mb-12">
								...
								<p className="text-muted-foreground text-lg max-w-xl mx-auto">
									To personalize your AI-powered coaching journey, tell us what career milestone
										...
										<button
											...
											className={`relative flex flex-col gap-6 p-8 rounded-xl cursor-pointer group text-left transition-all duration-300 backdrop-blur-md border ${
												isSelected
													...
													: "border-border bg-surface/30 hover:border-primary/50 hover:bg-primary/5 hover:-translate-y-1"
											}`}
										>
											{/* Selected Check */}
											{isSelected && (
											...
											<div
												className={`size-16 rounded-xl flex items-center justify-center shadow-lg ${
													isSelected
														...
														: "bg-surface-elevated group-hover:bg-primary/40 transition-colors"
												}`}
											>
							...
							<div className="flex flex-col items-center gap-4">
								<button
									...
									className="bg-primary hover:bg-primary-dark text-white font-bold text-lg px-12 py-4 rounded-lg transition-all shadow-xl shadow-primary/30 flex items-center gap-2 group"
								>
									Continue
			...
			{/* Footer Meta */}
			<footer className="w-full py-8 text-center border-t border-border bg-background">
				<p className="text-muted-foreground text-xs font-medium uppercase tracking-[0.2em]">
					SkillSage AI • Premium Interview Coaching
				</p>
			</footer>
		</div>
	);
