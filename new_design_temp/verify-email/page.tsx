			...
			<div className="relative z-10 flex h-full grow flex-col">
				...
				<header className="flex items-center justify-between px-6 py-8 md:px-20 max-w-7xl mx-auto w-full">
					<div className="flex items-center gap-3">
						<div className="size-8 bg-gradient-to-tr from-accent to-primary rounded-lg flex items-center justify-center">
							<svg
						...
						<h2 className="text-xl font-bold tracking-tight text-white">SkillSage</h2>
					</div>
				</header>
				...
				<main className="flex-1 flex items-center justify-center px-4 py-12">
					<div className="w-full max-w-[480px]">
						{/* Verification Card */}
						<div className="bg-surface/80 backdrop-blur-lg rounded-xl p-8 md:p-12 shadow-2xl border border-primary/10 text-center flex flex-col items-center">
							{/* Success Icon */}
							<div className="relative mb-8">
								...
								<div className="relative size-20 md:size-24 rounded-full bg-primary/10 border border-primary/30 flex items-center justify-center">
									<CheckCircle className="size-12 md:size-14 text-secondary" />
								</div>
							</div>
							...
							<div className="space-y-4 mb-10">
								<p className="text-muted-foreground text-lg leading-relaxed">
									Success! Your email has been verified. You&apos;re all set to begin your AI-powered
									interview journey.
								</p>
				...
				{/* Footer */}
				<footer className="px-6 py-10 w-full">
					<div className="max-w-7xl mx-auto flex flex-col items-center gap-6">
						...
						<p className="text-muted-foreground text-sm">
							© 2025 SkillSage AI. Empowering careers with intelligence.
						</p>
					</div>
				</footer>
			</div>
