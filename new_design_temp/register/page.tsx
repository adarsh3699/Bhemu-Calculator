...
import { Eye, EyeOff, User, Mail, ArrowRight, Brain } from "lucide-react";
	...
	return (
		<div className="flex min-h-screen w-full flex-row overflow-hidden">
			<AuthShowcase
				...
				subtitle="Master your interview. Secure your dream job with premium AI-powered coaching tailored just for you."
				testimonial={true}
			/>
			...
			<div className="flex flex-1 flex-col justify-center items-center p-6 lg:p-12 relative bg-background w-full lg:w-1/2 overflow-y-auto">
				...
				<div className="lg:hidden absolute top-6 left-6 flex items-center gap-2">
					...
					<span className="text-white text-xl font-bold">SkillSage</span>
				</div>
				...
				<div className="w-full max-w-md flex flex-col gap-6 mt-12 lg:mt-0">
					...
					<div className="flex flex-col gap-2">
						...
						<p className="text-gray-400">Start your journey with SkillSage today.</p>
					</div>

					{/* Social Buttons */}
					<div className="grid grid-cols-2 gap-4">
						<button className="flex items-center justify-center gap-2 h-12 rounded-lg border border-white/10 hover:bg-white/5 transition-colors bg-transparent text-white font-medium text-sm">
					...
					<form className="flex flex-col gap-4">
						...
						<button
							type="submit"
							className="mt-4 w-full h-12 bg-gradient-to-r from-primary to-accent hover:brightness-110 text-white font-bold rounded-lg shadow-lg shadow-primary/30 transition-all transform active:scale-[0.98] flex items-center justify-center gap-2 group"
						>
